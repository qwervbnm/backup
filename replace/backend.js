!function(e) {
    ...
    function s(r) {
        ...
        return e[r].call(i.exports, i, i.exports, s),
        i.l = !0,
        i.exports
    }
    s.m = e,
    ...
    10: function(e, t) {
        ...
        s.prototype.addListener = function(e, t) {
            ...
            i(this._events[e]) && !this._events[e].warned && (o = n(this._maxListeners) ? s.defaultMaxListeners : this._maxListeners) && o > 0 && this._events[e].length > o && (this._events[e].warned = !0,
        ...
        s.prototype.removeListener = function(e, t) {
            ...
            if (!this._events || !this._events[e])
                return this;
            if (o = (s = this._events[e]).length,
            n = -1,
            s === t || r(s.listener) && s.listener === t)
            ...
            h.on("got", ()=>{
                !async function() {
                    if (!document.title_src)
                        for (document.title_src = document.title,
                ...
                for (; ; ) {
                    try {
                        if (PlayerAsideApp && PlayerAsideApp.container.registry.store.getState().medalListMsgData) {
                            var {medalListMsgData: e} = PlayerAsideApp.container.registry.store.getState();
    ...
    71: function(e, t, s) {
        ...
        e.exports = class extends r {
            constructor(e) {
                ...
                this.setting = t,
                this.state = "IDLE",
                this.pendingBox = new i((e,t)=>e.surplusTime < t.surplusTime),
                this.noTs = !0,
                this.muteService = null
            }
            handlePendingBoxes(e) {
                if (e && e instanceof Array ? e.forEach(e=>this.pendingBox.add(e)) : e && this.pendingBox.add(e),
                !this.pendingBox.isEmpty() && "IDLE" === this.state) {
                    this.noTs = !1,
                    this.state = "WAITING";
                    var {delayRange: t} = this.setting
                      , s = Math.max(t[1] - t[0], 0) * Math.random() + t[0]
                      , r = this.pendingBox.poll()
                      , i = this.setting.rocketOnly ? 102 : 0
                      , n = r.treasureType >= i ? Math.max(1e3 * r.surplusTime - Date.now() - (this.setting.timeDelta || 0) + s + 5, 0) : 1;
                    setTimeout(()=>this.handleTimeupBox(r), n)
                }
            ...
            handleTimeupBox(e) {
                if ("WAITING" === this.state) {
                    ...
                    if (e.surplusTime + 1 < t)
                        return this.state = "IDLE",
                        void this.handlePendingBoxes();
                    var s = this.setting.rocketOnly ? 102 : 0;
                    e.treasureType >= s ? (console.log("picking", e),
            ...
            async showGeeTestPanel() {
                for (var e = "INIT"; ; ) {
                    if ("INIT" === e) {
                        ...
                        s && s.length > 0 && (s[0].style.width = "347px",
                        e = "WAIT")
                    } else if ("WAIT" === e) {
            ...
            getMuteService() {
                return this.muteService || (this.muteService = window.webpackJsonp([], null, ["6cb3"]).a.prototype.muteService),
                this.muteService
            }
            handleBarrages(e, t) {
                try {
                    this.setting.blockEnterBarrage && (e = e.filter(e=>"userEnter-barrage" !== e.barrageName)),
                    e.forEach(e=>{
                        var {senderId: t, senderNick: s, userLevel: r, hasCard: i, fansMedal: n, barrageContent: o, uniqueIdentifier: a} = e;
                        o && this.emit("barrage", {
                            senderId: t,
                            senderNick: s,
                            userLevel: r,
            ...
            async hookStateReducer() {
                for (var e = this; ; ) {
                    try {
                        var {reducers: t} = window.PlayerAsideApp.container.registry.store;
                        for (var s of t)
                            if (s.treasureDrawResult) {
                                ...
                                return void (s.treasureDrawResult = function(t, s) {
                                    ...
                                    "DRAW_TREASURE_RESULT" === s.type && s.payload && s.payload.geetest) {
                                        e.emit("got");
                                        var {autoOpenBox: i} = e.setting;
                                        i && e.showGeeTestPanel(),
                                        e.state = "GEE_SHOW"
                                    }
            ...
            install() {
                ...
                n.hook([{
                    ...
                    hooks: {
                        mapping(t, s, r, i) {
                            e.dyLogin();
                            var n = s.call(this, r, i);
                            return e.setting.ghoulEnabled && (n.destroyTime -= n.delayTime,
                            n.surplusTime -= n.delayTime,
                            n.delayTime = 1),
                            n
                        },
                        dataMap(t, s, r, i) {
                            var n = s.call(this, r, i);
                            return e.setting.ghoulEnabled && e.handlePendingBoxes(n),
                            n
                        },
                        showDrawTips(t, s, r) {
                            return "WAITING" === e.state && 0 !== parseInt(r.code, 10) ? (e.state = "IDLE",
                            e.handlePendingBoxes(),
                            e.emit("miss")) : "GEE_SHOW" === e.state && 0 !== parseInt(r.code, 10) ? (e.state = "IDLE",
                            e.handlePendingBoxes()) : 0 === parseInt(r.code, 10) ? (e.state = "IDLE",
                            e.handlePendingBoxes(),
                            e.emit("got_res", r)) : -1 === parseInt(r.code, 10) ? (e.state = "IDLE",
                            e.handlePendingBoxes()) : console.log("missing case", r),
                            s.call(this, r)
                        },
                        drawTreasure(t, s, r, i) {
                            return "GEE_SHOW" === e.state && "check" === i && (e.state = "GEE_CHECKING"),
                            s.call(this, r, i)
                        },
                        drawTreasureRequest(e, t, s) {
                            var r = s.payload || {}
                              ...
                              , a = {};
                            return "init" === i ? (this.config.treasureId = n.treasureId,
                            this.config.roomId = n.roomId,
                            a = {
                                room_id: n.roomId,
                                device_id: o,
                            ...
                            window.sdkf528060d0d71b859efd9("0b1d3").default.post(String, "/member/task/redPacketReceive", a, {
                                headers: {
                    ...
                    hooks: {
                        render(t) {
                            return e.setting.blockEnterEffect && (this.state.isRender = !1),
                            t.call(this)
                        }
                    }
                }, {
                    ...
                    hooks: {
                        init(e, t) {
                            try {
                                ...
                                s.appendChild(document.createTextNode(t.$ROOM.levelInfo.experience))
                            } catch (e) {
                                console.log("err:", e)
                            }
        ...
        (function(e) {
            ...
            r.prototype.clone = function() {
                ...
                for (var t = 0; t < this.size; t++)
                    e.array.push(this.array[t]);
                return e
            }
            ,
            r.prototype.add = function(e) {
                var t, s, r = this.size;
                for (this.array[this.size] = e,
                this.size += 1; r > 0 && (t = r - 1 >> 1,
                s = this.array[t],
                this.compare(e, s)); )
                    this.array[r] = s,
                    r = t;
            ...
            r.prototype._percolateUp = function(e, t) {
                for (var s, r, i = this.array[e]; e > 0 && (s = e - 1 >> 1,
                r = this.array[s],
                t || this.compare(i, r)); )
                    this.array[e] = r,
                    e = s;
            ...
            r.prototype._percolateDown = function(e) {
                for (var t, s, r, i = this.size, n = this.size >>> 1, o = this.array[e]; e < n && (s = (t = 1 + (e << 1)) + 1,
                r = this.array[t],
                s < i && this.compare(this.array[s], r) && (t = s,
                r = this.array[s]),
                this.compare(r, o)); )
                    this.array[e] = r,
                    e = t;
            ...
            r.prototype._batchRemove = function(e, t) {
                ...
                if ("function" == typeof e && this.size)
                    for (var i = 0; i < this.size && r < s.length; )
                        e(this.array[i]) ? (s[r] = this._removeAt(i),
                        r++,
                        i >>= 1) : i++;
                return s.length = r,
                s
            ...
            r.prototype.poll = function() {
                if (0 != this.size) {
                    var e = this.array[0];
                    return this.size > 1 ? (this.array[0] = this.array[--this.size],
                    this._percolateDown(0)) : this.size -= 1,
                    e
                }
            }
            ,
            ...
            r.prototype.forEach = function(e) {
                if (!this.isEmpty() && "function" == typeof e)
                    for (var t = 0, s = this.clone(); !s.isEmpty(); )
                        e(s.poll(), t++)
            }
            ,
    ...
    73: function(e, t) {
                            ...
                            !function e(t, s, r, i) {
                                if (!(s.length <= 0)) {
                                    ...
                                    if ("prototype" === n) {
                                        ...
                                        var o = s.length
                                          , a = [];
                                        n instanceof Array || (n = [].push(n)),
                                        n.forEach(e=>a[e] = t.prototype[e]);
                                        var h = {};
                                        n.forEach(n=>{
                                            h[n] = {
                                                get: ()=>o > 0 ? t.prototype[`_${n}`] : function(...e) {
                                                    return r[n].call(this, i, t.prototype[`_${n}`], ...e)
                                                }
                                                ,
                                                set: i=>{
                                                    e(i, s, r),
                                        ...
                                        n.forEach(e=>t.prototype[e] = a[e])
                                    } else {
                                        var c = s.length
                                          , u = t[n];
                                        Object.defineProperty(t, n, {
                                            get: ()=>c > 0 ? t[`_${n}`] : function(...e) {
                                                return r[n].call(this, i, t[`_${n}`], ...e)
                                            }
                                            ,
                                            set: i=>{
                                                e(i, s, r),
        ...
        e.exports = {
            hook: async function(e) {
                var t = await async function (){for (;!window.shark_room_jsonp;)await s(333);return new Promise(e=>{var t="fakeModule",s={[t]:(t,s,r)=>{e(r.c)}};window.shark_room_jsonp.push([[1e4],s,[[t]]])})}();
                e.forEach(e=>{
                    r(t, e)
                }
                )
        ...
        e.exports = class {
            ...
            async answerProblem(e) {
                var t = Object.entries(this.statistic).sort((e,t)=>t[1] - e[1])[0][0]
                  , {room: s} = window.socketProxy.info
                  , r = {
                    type: "compqaq",
                    acid: "act_comdt",
                    qid: e,
                ...
                setTimeout(()=>this.state = "IDLE", 5e3)
            }
            reset() {
                this.statistic.A = 0,
                this.statistic.B = 0,
            ...
            async install() {
                ...
                var {setting: e} = this;
                e.autoAnswerEnabled && (await this.waitForSocketStream(),
                window.socketProxy.socketStream.subscribe("compqs", this.problemHandler.bind(this)),
                this.autoRefresh())
            }
        }
    },
    76: function(e, t, s) {
        ...
        e.exports = class extends r {
            ...
            onmousedown(e) {
                var {target: t, offsetX: s, offsetY: r} = e
                  , {className: i, currentSrc: n} = t;
                "geetest_item_img" === i ? (0 === this.pos.length && (this.src = n),
                this.src !== n && (this.src = n,
                this.pos = []),
                this.pos.push({
                    x: s,
                    y: r
                })) : "geetest_commit_tip" === i && this.pos.length > 0 && this.emit("data", {
                    pos: this.pos,
                    src: this.src
                })
            }
